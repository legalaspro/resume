...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://manajev.com/}{\Large Dmitri Manajev}} & \multirow{6}{*}{\includegraphics[width=3.5cm]{photo.jpg}}\\
...
\section{Skills}
 \resumeSubHeadingListStart
    \resumeSubItem{Robotics Software}
      {ROS~2 and ROS~1, ros2\_control, Nav2, Behavior Trees, MoveIt~2 / MoveIt Pro, tf2, URDF/Xacro;
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Develop and commission production ROS~2 software in C++ and Python for autonomous mobile cleaning robots, covering Nav2 navigation, MoveIt Pro manipulation, motion control and systems integration.}
